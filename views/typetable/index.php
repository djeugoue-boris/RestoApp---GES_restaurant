    ...
    <div class="row">
        <div class="col-md-offset-1 col-md-10 col-md-offset-1">
            ...
            <div class="text-right">
                <a href="app.php?view=typetable_create" class="btn btn-info">
            ...
            <h4>Liste des types de tables</h4>
...
if($typetables != null && sizeof($typetables) > 0) {
    $i= 0;
    foreach ($typetables as $typetable) {
        $i++;
        $update= 'app.php?view=typetable_update&idtypetable=' . $typetable->idtypetable;
        $delete= 'controller/typetableController.php?action=delete&idtypetable='.$typetable->idtypetable;
